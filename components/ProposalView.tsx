  ...
  return (
    <div className="w-full max-w-5xl mx-auto my-10 animate-fade-in-up proposal-container">
        ...
        <div className="bg-white rounded-none md:rounded-xl shadow-2xl border border-slate-200 overflow-hidden print:shadow-none print:border-none print:w-full">
            ...
            {/* Document Header */}
            <div className="bg-slate-900 text-white p-10 print:bg-white print:text-black print:border-b-2 print:border-black">
            ...
            {/* Document Content */}
            <div className="p-10 md:p-14 min-h-[600px] prose prose-slate max-w-none prose-headings:font-bold prose-h2:text-blue-800 prose-h3:text-slate-800 prose-table:border-collapse prose-th:bg-slate-100 prose-th:p-3 prose-td:p-3 prose-td:border-b prose-a:text-blue-600">
                <ReactMarkdown 
                    components={{
            ...
            {/* Document Footer */}
            <div className="bg-slate-50 p-10 border-t border-slate-200 print:bg-white print:border-t-2 print:border-black">
